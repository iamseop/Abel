...
const PersonalityResult: React.FC<PersonalityResultProps> = ({ result, onReset }) => {
  ...
  return (
    <div className="space-y-6">
      {/* 결과 헤더 */}
      <div className={`glass-card p-8 text-center bg-gradient-to-r ${result.color}`}>
        <div className="mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">투자 성향 특징</h2>
          </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">추천 자산 배분</h2>
          </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">추천 투자 상품</h2>
          </div>
          <div className="space-y-3">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">추천 투자 전략</h2>
          </div>
          <div className="space-y-3">
      ...
      <div className="glass-card p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-white">투자 시 주의사항</h2>
        </div>
      ...
      <div className="glass-card p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20">
        <h3 className="text-white font-bold text-lg mb-4">💡 투자 성향 활용 팁</h3>
